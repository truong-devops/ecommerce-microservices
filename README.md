...
- Kubernetes workloads are separated into `ecommerce-dev` for `develop` and `ecommerce-prod` for `main`; development promotion is automated only after Harbor is configured.
