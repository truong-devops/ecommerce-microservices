...
- Với demo hiện tại, buyer ưu tiên xem WebRTC realtime nếu seller bấm phát; nếu chưa có WebRTC thì fallback về `playbackUrl`.
- Giới hạn: đây là P2P demo cho 1 buyer chính. Production nhiều viewer cần SFU/media server hoặc RTMP/WebRTC ingest như MediaMTX/LiveKit/Janus.
...
WS_ALLOWED_ORIGINS=http://localhost:6789,http://localhost:8888,http://localhost:3000,http://localhost:3001
