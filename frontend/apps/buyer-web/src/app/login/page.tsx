  ...
  return (
    <div className="min-h-screen bg-app-bg text-slate-900">
      ...
      <main className="mx-auto flex w-full max-w-[1200px] justify-center px-3 py-6 md:px-4 md:py-8">
        <section className="w-full max-w-md rounded-md bg-white p-5 shadow-card md:p-6" aria-labelledby="login-title">
          <h1 id="login-title" className="text-2xl font-bold text-brand-600">
          ...
          <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
            ...
            >
              {isSubmitting ? `${text.auth.submitLogin}...` : text.auth.submitLogin}
            </button>
          </form>
