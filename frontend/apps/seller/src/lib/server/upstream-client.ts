...
const NOTIFICATION_SERVICE_BASE_URL = process.env.NOTIFICATION_SERVICE_BASE_URL ?? API_GATEWAY_BASE_URL;
...
const MEDIA_SERVICE_BASE_URL = process.env.MEDIA_SERVICE_BASE_URL ?? API_GATEWAY_BASE_URL;
