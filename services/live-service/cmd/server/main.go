...
func main() {
	...
	repo := repository.NewLiveRepository(mongoClient.Database(cfg.MongoDatabase))
	...
	wsHandler := handler.NewWSHandler(liveService, redisService, hub, cfg.WSAllowedOrigins)
	healthHandler := handler.NewHealthHandler(healthService)
	httpHandler := router.New(cfg, logger, redisService, liveHandler, wsHandler, healthHandler)
	...
	go func() {
		logger.Info("live-service started",
