...
type ProductRepository interface {
	...
	FindBySlug(ctx context.Context, sellerID string, slug string, excludeID string) (*domain.Product, error)
	FindFirstBySKUs(ctx context.Context, sellerID string, skus []string, excludeID string) (*domain.Product, error)
...
func (r *mongoProductRepository) EnsureIndexes(ctx context.Context) error {
	// The Nest version used a global slug index. Product slugs only need to be
	// unique within a seller; otherwise sellers can block each other with common names.
	_, _ = r.collection.Indexes().DropOne(ctx, "slug_1")
...
func (r *mongoProductRepository) FindBySlug(ctx context.Context, sellerID string, slug string, excludeID string) (*domain.Product, error) {
...
func (r *mongoProductRepository) FindFirstBySKUs(ctx context.Context, sellerID string, skus []string, excludeID string) (*domain.Product, error) {
