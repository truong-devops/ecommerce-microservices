...
var productIDPattern = regexp.MustCompile(`^[A-Za-z0-9][A-Za-z0-9._:-]{5,127}$`)

func NewReviewHandler(reviewService service.ReviewService) *ReviewHandler {
	validate := validator.New(validator.WithRequiredStructEnabled())
	_ = validate.RegisterValidation("productid", func(fl validator.FieldLevel) bool {
...
type createReviewRequest struct {
	...
	ProductID string   `json:"productId" validate:"required,productid"`
...
type listReviewsRequest struct {
	...
	ProductID *string              `validate:"omitempty,productid"`
