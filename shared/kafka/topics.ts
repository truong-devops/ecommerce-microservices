export const KAFKA_TOPICS = {
  ...
  VIDEO_VIEW_STARTED: 'video.view_started',
  VIDEO_VIEW_QUALIFIED: 'video.view_qualified',
  VIDEO_PRODUCT_CLICKED: 'video.product_clicked',
  VIDEO_ADD_TO_CART: 'video.add_to_cart',
